...
public static partial class Solution
{
    ...
    public static void P156Test1()
    {
        ...
        TreeNode<int>.ConnectTreeNodes<int>(pNode8, pNode6, pNode10);
        TreeNode<int>.ConnectTreeNodes<int>(pNode6, pNode5, pNode7);
        TreeNode<int>.ConnectTreeNodes<int>(pNode10, pNode9, pNode11);

        TreeNode<int>.Print2D<int>(pNode8);
    ...
    public static void P156Test2()
    {
        ...
        TreeNode<int>.ConnectTreeNodes<int>(pNode8, pNode7, null);
        TreeNode<int>.ConnectTreeNodes<int>(pNode7, pNode6, null);
        TreeNode<int>.ConnectTreeNodes<int>(pNode6, pNode5, null);
        TreeNode<int>.ConnectTreeNodes<int>(pNode5, pNode4, null);
    ...
    public static void P156Test3()
    {
        ...
        TreeNode<int>.ConnectTreeNodes<int>(pNode8, null, pNode7);
        TreeNode<int>.ConnectTreeNodes<int>(pNode7, null, pNode6);
        TreeNode<int>.ConnectTreeNodes<int>(pNode6, null, pNode5);
        TreeNode<int>.ConnectTreeNodes<int>(pNode5, null, pNode4);
    ...
    public static void P156Test4()
    {
        ...
        TreeNode<int>.Print2D<int>(pNode);
